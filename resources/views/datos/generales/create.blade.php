	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		<div class="form-group">
			...
			<select name="nacionalidad" class="form-control select2">
				@if (old('nacionalidad') == "MEXICANA")
				<option value="MEXICANA" selected >MEXICANA</option>
				@else
				<option value="MEXICANA"  >MEXICANA</option>
				@endif
				@if (old('nacionalidad') == "EXTRANJERA")
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		<div class="form-group">
			...
			<select name="edo_nacimiento" class="form-control" >
				...
				@if(old('edo_nacimiento') == $estado->nombre)
	...
	<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
		<div class="form-group">
			...
			<select name="edo_civil" class="form-control select2">
				@if (old('edo_civil') == "CASADO") 
				<option value="CASADO" selected>CASADO</option>
				@else
				<option value="CASADO" >CASADO</option>
				@endif
				@if (old('edo_civil') == "SOLTERO")
                <option value="SOLTERO" selected>SOLTERO</option>
                @else
                <option value="SOLTERO" >SOLTERO</option>
                @endif
                @if (old('edo_civil') == "UNION LIBRE")
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			...
			<select name="dom_estado" class="form-control" value="{{old('dom_estado')}}">
				...
				@if(old('dom_estado') == $estado1->nombre)
	...
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			...
			<input type="text" name="dom_municipio" class="form-control" value="{{old('dom_municipio')}}">
		</div>
	</div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			<label>Localidad</label>
			<input type="text" name="dom_localidad" class="form-control" value="{{old('dom_localidad')}}">
		</div>
	</div>
</div>
</div>
	...
	<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
		<div class="form-group">
			<label>Calle</label>
			<input type="text" name="dom_calle" class="form-control" value="{{old('dom_calle')}}">
		</div>
	</div>
	<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
		<div class="form-group">
			<label>Número</label>
			<input type="text" name="dom_numero" class="form-control" value="{{old('dom_numero')}}">
		</div>
	</div>
	</div>
	</div><!--div class=row-->
	...
	<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
		<div class="form-group">
			...
			<select name="convenio" class="form-control" >
				...
				@if(old('convenio') == $convenio->nombre)
...
<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
	...
	<div class="box box-primary"><br>
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="form-group">
					<input type="text" name="ocupacion" class="form-control" value="{{old('ocupacion')}}" placeholder="Ocupacíon">
					</div>
			</div>
		</div>
	</div>
