...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		...
		{!!Form::open(array('url'=>'expediente/formatos/ne', 'method'=>'POST', 'autocomplete'=>'off'))!!}
		{{Form::token()}}
...
<div class="row">
	...
	<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
			<div class="form-group">
				...
				<input type="time" name="hconsulta" value="{{old('hconsulta')}}" class="form-control">
			</div>
	</div>
...
<div class="row">
	...
	<div class="box box-info">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="form-group">
				<textarea class="form-control" name="dactual" rows="4" placeholder="Diagnóstico Actual"></textarea>
				</div>
		</div>
	...
	<div class="box box-info">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="form-group">
				<textarea class="form-control" rows="4" placeholder="Indicaciones Médicas" disabled=""></textarea>
				</div>
		</div>
