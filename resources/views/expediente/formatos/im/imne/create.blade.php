...
@section ('title')
<h> INDICACIONES MÉDICAS: NOTA DE EGRESO</h>
@endsection
@section ('contenido')

{!!Form::open(array('url'=>'expediente/formatos/im/imne/', 'method'=>'POST', 'autocomplete'=>'off'))!!}
{{-- {{Form::token()}} --}}
		
	@include('expediente.formatos.im.form')
	<input type="hidden" name="idne"  value="{{$idne}}" class="form-control">
