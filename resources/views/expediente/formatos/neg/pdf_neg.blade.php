...
<div class="corners">
   <h3 align="CENTER">NOTA DE EGRESO</h3>
</head>
<body >
	...
	<div>
    	<div class="row">
    		...
    		<div class="column col-30" ></div>
  			<div class="column col-15" >
    			<label><b>TRIAGE: </b>{{$neg->triage}}</label>
  			</div>
		</div>
		...
		<div class="row">
			...
			<div class="column col-30" ></div>
		  	...
		  	<div class="column col-15" >
		    	<label><b>FOLIO: </b>{{$neg->folio}}</label>
		  	</div>
		</div>

		<div class="row">
			<div class=" column col-20">
				<label><b>FECHA: </b>{{$neg->created_at->format('Y-m-d')}}</label>
			</div>
			<div class=" column col-30">
				<label><b>HORA DE INGRESO: </b>{{$p->created_at->format('H:m')}}</label>
			</div>
			<div class=" column col-30">
				<label><b>HORA DE CONSULTA: </b>{{$neg->hora_c}}</label>
			</div>
		</div>	
		...
		<div class="row">
			<textarea id="texta">{{$neg->descripcion}}
			</textarea>
		</div>
		<hr>
		<div class="row">
		...
		<div class="row">
			<div class=" column col-40">
				<label><b>V. DIAGNÓSTICO DE EGRESO:</b></label>
			</div>
		</div>
		<div class="row">
			<textarea id="texta">{{$neg->degreso}}
			</textarea>
		</div>
		<hr>
		...
		<div class="row">
			<textarea id="texta">{{$neg->ind_medicas}}
			</textarea>
		</div>
